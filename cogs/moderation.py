...
class Moderation(commands.Cog):
    ...
    async def ban(self, ctx, member: discord.Member=None, *, reason="None"):
        ...
        try:
            if ctx.author.top_role > member.top_role:
                ...
                embed=discord.Embed(description="**<:red_cross:844165297538727956> | You are not allowed to moderate users that are higher than your highest role**", color=discord.Color.red())
                return await ctx.send(embed=embed)
        except:
            await member.ban(reason=reason)
    ...
    @commands.command(help='Sets a member\'s nickname')
    ...
    async def unmute(self, ctx, member: discord.Member=None, *, reason="None"):
        ...
        embed = discord.Embed(title="**<:green_tick:844165352610725898> | Member Unmuted**", description=f'**Reason:** {reason}\n**Moderator:** {ctx.author.mention}', color=discord.Color.green())
        await ctx.send(embed=embed)
